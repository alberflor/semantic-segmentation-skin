...
\begin{figure}[!htp]
    \centering
    \subfloat[]{\label{a}\includegraphics[width=50mm]{Figuras/input_1.png}}
    \qquad
    \subfloat[]{\label{b}\includegraphics[width=50mm]{Figuras/mask_1.png}}
    \caption{Comparación de dato de entrada (a) y la salida deseada (b).}
    \label{data_1}
\end{figure}

En la figura \ref{data_1} (a) se observa como la imagen entrante presenta un caso de melanoma y posteriormente, en la figura \ref{data_1}(b) se puede observar la misma imagen segmentada en donde la región que corresponde al melanoma se 
