...
\begin{figure}[!htp]
    \centering
    \subfloat[imágen entrante]{\label{a_1}\includegraphics[width=50mm]{Figuras/input_1.png}}
    \qquad
...
\begin{figure*}[ht]
    ...
    \begin{tabular}{ccc}\ContinuedFloat
        ...
        \includegraphics[width=3.5cm]{../Plots/dl_epoch_16.png} &
        \includegraphics[width=3.5cm]{../Plots/dl_epoch_17.png} \\
    \end{tabular}        
    \caption{Curva de la pérdida según el coeficiente de dados en cada época.}
    \label{fig:dice_loss_epochs}
\end{figure*}
...
\begin{figure*}[ht]\ContinuedFloat
    ...
    \begin{tabular}{ccc}
        ...
        \includegraphics[width=3.5cm]{../Plots/score_epoch_16.png} &
        \includegraphics[width=3.5cm]{../Plots/score_epoch_17.png} \\
    \end{tabular}
