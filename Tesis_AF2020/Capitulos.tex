...
\begin{figure}[!htp]
    \centering
    \subfloat[]{\label{a_1}\includegraphics[width=50mm]{Figuras/input_1.png}}
    \qquad
    \subfloat[]{\label{b_1}\includegraphics[width=50mm]{Figuras/mask_1.png}}
...
\begin{figure}[!htp]
    \centering
    \subfloat[]{\label{a}\includegraphics[width=50mm]{Figuras/bg_matrix.eps}}
    \qquad
    \subfloat[]{\label{b}\includegraphics[width=50mm]{Figuras/rgb_matrix.eps}}
...
En la primera sección, \emph{trabajos similares}, se recopilan trabajos con características relacionadas al presente trabajo de tesis, ya sea relacionados con el método o con el problema que se pretende resolver, \coltext{se describe el tema que abarcan y los puntos que lo relacionan con el trabajo aquí presente.}
...
\coltext{Arreglar posición de la tabla.}
...
En este trabajo de tesis se pretende desarrollar una herramienta para la detección del cáncer en la piel del tipo melanoma aprovechando las propiedades de las redes neuronales profundas para la detección y segmentación del padecimiento. Para comprobar la hipótesis se desarrolló un software que contiene una arquitectura de tipo red neuronal profunda convolucional de segmentación semántica, la cuál es entrenada para segmentar las imágenes y clasificar el tejido sano del tejido canceroso.

En la sección de \emph{metodología}, se definen los procedimientos y métodos utilizados para la obtención del resultado deseado en la solución propuesta. Así mismo se describen a detalle las fases que atraviesan los datos desde su ingreso al sistema en forma de imágenes,  hasta su salida del sistema como un mapa de característica segmentado en sus respectivas categorías.

Después en \emph{descripción de los datos}, se da una breve descripción de la base de datos proporcionada por la colaboración internacional de recolección de imágenes de la piel \citep{isic_skin}, por sus siglas en inglés (\emph{ISIC}\footnote{ISIC: International Skin Imaging Collaboration.}), se describe estadísticamente la población de los datos y los meta-datos. 

Finalmente en \emph{implementación de la solución}, se describen brevemente las características del hardware en el que serán realizados los entrenamientos del sistema, posterior a eso se relata a profundidad la implementación del sistema y los parámetros utilizados.

\section{Metodología}
\subsection{Filtro de Convolución}
\subsection{Función de Costo de la Propuesta}
\subsection{Comparación de Codificadores}

\section{Descripción de los Datos}
\subsection{Estadísticas}
\subsection{Regla del Pareto}
