...
En el código \ref{code:load_2} se invoca la función \emph{dataset}, la cuál tiene por argumento la dirección de las imágenes reales y las máscaras conocidas, con esto se crea el conjunto de datos que posteriormente es utilizado en la  
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance = 0.2cm and -0.5cm]
        ...
        \node [block, below right= of tr1] (tr2) {Interpolate (\small INTER$\_$AREA)};
